...
\begin{itemize}
% check the author list for the paper below (for now copying from previous paper)
\item Anil Can, Robert F Rudy, Victor Castro, Sheng Yu, Dmitriy Dligach, Sean Finan, Vivian S Gainer, Nancy A Shadick, Guergana Savova, Shawn Murphy, Tianxi Cai, Scott Weiss, and Rose Du. Elevated International Normalized Ratio is Associated with Ruptured Aneurysms. \emph{Stroke}. 2018.
