...
\begin{itemize}
\item Professor, Loyola University Chicago, 2026 - present.
\item Associate Professor, Loyola University Chicago, 2021 - 2026.
...
\item Associate Scientific Research Staff, Boston Children's Hospital, 2014 - 2015.
...
\begin{itemize}
\item Jennifer Martin, Majid Afshar, Askar Safipour Afshar, John Caskey, Dmitriy Dligach, Yanjun Gao, Jifan Gao, Guanhua Chen, Anoop Mayampurath, Matthew M. Churpek. Explainable multimodal deep learning models for variable-length sequences in critically ill patients. \emph{Journal of Biomedical Informatics (JBI)}. 2026.
\item Behnaz Eslami, Dmitriy Dligach, Nazanin Azarvash, Paula de la Pena, Benjamin Strickland, Samie Tootooni. A Hybrid Language Framework for Ontology-Based Clinical Concept Extraction. \emph{Journal of Healthcare Informatics Research}. 2026.
\item Rohan Sethi, John Caskey, Yanjun Gao, Matthew M. Churpek, Timothy A. Miller, Anoop Mayampurath, Elizabeth Salisbury-Afshar, Majid Afshar, Dmitry Dligach. Detecting stigmatizing language in clinical notes with large language models for addiction care. \emph{npj Health Systems}. 2026.
\item Jack Gallifant, Lizhou Fan, Ziqian Liao, Shan Chen, Hugo J.W.L. Aerts, Dmitriy Dligach, Ramez Kouzy, Danielle Bitterman. Evaluating the use of LLMs to answer patient-facing clinical trial questions. \emph{JCO Oncology Advances}. 2025. 
\item Emma Croxford, Yanjun Gao, Elliot First, Nicholas Pellegrino, Miranda Schnier, John Caskey, Madeline Oguss, Graham Wills, Guanhua Chen, Dmitriy Dligach, Matthew M. Churpek, Anoop Mayampurath, Frank Liao, Cherodeep Goswami, Karen K. Wong, Brian W. Patterson, Majid Afshar. Evaluating clinical AI summaries with
large language models as judges. \emph{npj Digital Medicine}. 2025.
\item Samuel Nycklemoe, Sriharsha Devarapu, Yanjun Gao, Kyle Carey, Nicholas Kuehnel, Neil Munjal, Priti Jani, Matthew Churpek, Dmitry Dligach, Majid Afshar, Anoop Mayampurath. Explaining Alerts from a Pediatric Risk Prediction Model Using Clinical Text. \emph{Journal of the American Medical Informatics Association (JAMIA)}. 2025.
\item Behnaz Eslami, Majid Afshar, Samie Tootooni, Timothy A. Miller, Matthew M. Churpek, Yanjun Gao, Dmitriy Dligach. Toward Digital Twins in the Intensive Care Unit: A Medication Management Case Study. \emph{Journal of the American Medical Informatics Association (JAMIA)}. 2025.
...
\begin{itemize}
\item He Cheng, Yifu Wu, Saksham Khatwani, Maya Kruse, Dmitriy Dligach, Timothy A. Miller, Majid Afshar, Yanjun Gao. LogosKG: Hardware-Optimized Scalable and Interpretable Knowledge Graph Retrieval. In \emph{Proceedings of the 64th Annual Meeting of the Association for Computational Linguistics (ACL)}. San-Diego, CA. July, 2026.
\item Behnaz Eslami, Dmitriy Dligach, Benjamin Strickland, Nazanin Azarvash, M. Samie Tootooni. A Performance-Based Voting Framework for Assertion Detection in Clinical Notes. In \emph{MedInfo 2025}. Taipei, Taiwan. August 2025.
\item Croxford, Emma Leigh, Yanjun Gao, Brian W. Patterson, Daniel Chern-Hui To, Samuel Tesch, Dmitriy Dligach, Anoop Mayampurath, Matthew M. Churpek, Majid Afshar. Development of a Human Evaluation Framework and Correlation with Automated Metrics for Natural Language Generation of Medical Diagnoses. In \emph{Proceedings of American Medical Informatics Association Symposium 2024}. San Francisco, CA. April, 2024.
...
\begin{itemize}
\item Michael T. Saban, Arsalan Yaghoubi, Behnaz Eslami, Samie Tootooni, Dmitriy Dligach. Lakefront AI Ramblers at MEDIQA-SYNUR 2026: Hybrid Retrieval and LLM Verification for Open-Source Schema-Guided Clinical Information Extraction. In \emph{Proceedings of The 8th Clinical Natural Language Processing Workshop (ClinicalNLP 2026) held in conjunction with LREC 2026}. May 2026. Mallorca, Spain.
\item He Cheng, Yifu Wu, Saksham Khatwani, Dmitriy Dligach, Timothy Miller, Majid Afshar and Yanjun Gao. Efficient and Scalable Retrieval in Knowledge Graphs: From Single-Graph to Partitioned Multi-Graph Approaches. \emph{AMIA NLP Working Group Pre-Symposium Workshop}. November 2025. Atlanta, GA.
\item Saksham Khatwani, He Cheng, Majid Afshar, Dmitriy Dligach, Yanjun Gao. Brittleness and Promise: Knowledge Graph–Based Reward Modeling for Diagnostic Reasoning. \emph{GenAI4Health Workshop at NeurIPS 2025}. December 2025. San-Diego, CA. 
...
\begin{itemize}
\item Xu Z, Zeng J, Zhou S, Chen YH, Yaghoubi A, Goddla V, Lehmann L, Sharon E, Kozono D, Revette A, Maués J, Brown T, Dligach D, Bitterman D. Automated safety and quality oversight of large language model chatbots for cancer clinical trial informed consent. Oral presentaton at \emph{American Medical Informatics Association Annual Symposium}. Dallas, TX. November 2026.
\item Behnaz Eslami, Dmitriy Dligach, Kathleen L Bobay, Mark E Cichon, Samie Tootooni. Mapping Free-Text Chief Complaints to a Structured Clinical Taxonomy Using LLM-Based Soft Classification. Poster at \emph{American Medical Informatics Association Annual Symposium}. Dallas, TX. November 2026.
\item Behnaz Eslami, Dmitriy Dligach, Nazanin Azarvash, Paula de la Pena, Benjamin Strickland, Samie Tootooni. A Hybrid Language Framework for Ontology-Based Clinical Concept Extraction. \emph{American Medical Informatics Association Annual Symposium}. Dallas, TX. November 2026.
\item Michael T. Saban, Samie Tootooni, WonJin Yoon, Timothy Miller, Dmitriy Dligach. Multimodal Fusion of Structured EHR Data and Clinical Notes for 30-Day Mortality Prediction. Poster at \emph{American Medical Informatics Association Annual Symposium}. Dallas, TX. November 2026.
\item Skatje Myers, Dmitriy Dligach, Timothy A. Miller, Samantha Barr, Yanjun Gao, Matthew M. Churpek, Anoop Mayampurath, Majid Afshar. Evaluating Retrieval-Augmented Generation vs. Long-Context Input for Antibiotic Timeline Extraction from EHRs. Poster at \emph{AMIA 2026 Informatics Summit}. Denver, CO. 2026.
\item Xu, Z., Zeng, J., Zhou, S., Chen, Y.-H., Yaghoubi, A., Goddla, V., Lehmann, L., Sharon, E., Kozono, D., Revette, A., Dligach, D., Bitterman, D. Automated safety and quality oversight of large language model chatbots for cancer clinical trial informed consent. Poster presentation at \emph{American Society for Radiation Oncology (ASTRO) 2026 Annual Meeting}. Boston, MA, United States.
\item Skatje Myers, Dmitriy Dligach, Timothy A. Miller, Graham Wills, Matthew M. Churpek, Anoop Mayampurath, and Majid Afshar. Improving Automated ICD-10 Coding Through Finetuning of Smaller LLMs. \emph{AMIA 2026 Informatics Summit}. Denver, CO. 2026.
\item Anoop Mayampurath, Samuel Nycklemoe, Jennie Martin, Sierra Strutz, John Caskey, Kyle Carey, Emma Croxford, Priti Jani, Neil Munjal, Dmitriy Dligach, Matthew Churpek, Majid Afshar. Using Large Language Models To Explain Alerts From A Pediatric Risk Stratification Model. \emph{2026 Critical Care Congress (Society of Critical Care Medicine)}. Chicago, IL. March 2026.
\item Croxford E, Gao Y, First E, Pellegrino N, Schnier M, Caskey J, Wills G, Chen G, Dligach D, Churpek MM, Mayampurath A, Liao F, Wong KK, Patterson B, Afshar M. Derivation and validation of acceptable provider documentation summarization quality instrument (PDSQI-9) thresholds for evaluating large language model-based clinical documentation. Poster presented at \emph{American Medical Informatics Association (AMIA) Clinical Informatics Conference}. Denver, CO. May 2026.
...
\begin{itemize}
\item COMP 388/488: Large Language Models. Loyola University Chicago. Spring 2026.
\item COMP 488: Graduate Seminar on Large Language Models. Loyola University Chicago. Spring 2025.
\item COMP 379/479: Machine Learning. Loyola University Chicago. Fall 2016-2026.
\item COMP 329/429: Natural Language Processing. Loyola University Chicago. Spring 2018-2026.
...
\begin{itemize}
\item ACL Rolling Review (ARR). Paper Reviewer. June 2026.
\item ACL Rolling Review (ARR). Paper Reviewer. February 2026.
\item Journal of American Medical Informatics Association. Paper Reviewer. September 2025.
\item ACL Rolling Review (ARR). Paper Reviewer. November 2025.
...
\begin{itemize}
\item PhD thesis committee. Shan Chen. Harvard-Mass General Brigham AI in Medicine Program. 2026.
\item PhD advisor. Arsalan Yaghoubi. Loyola University Chicago. 2025-present.
