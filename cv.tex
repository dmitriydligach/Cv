...
\item Associate Scientific Researcher, Boston Children's Hospital, 2014 - present.
...
\begin{itemize}
\item *Chen Lin, *Dmitriy Dligach, *Timothy Miller, *Steven Bethard, Guergana Savova. Layered Temporal Modeling for the Clinical Domain. \emph{Journal of American Medical Informatics Association}. Under Revision. * \underline{Indicates co-first authors}
\item *Chen Lin, *Elizabeth W. Karlson, *Dmitriy Dligach, Monica Ramirez, Timothy A. Miller, Huan Mo, Natalie S. Braggs, Andrew Cagan, Joshua C. Denny, Guergana K. Savova. Automatic Identification of Methotrexate-induced Liver Toxicity in Rheumatoid Arthritis Patients from the Electronic Medical Record. \emph{Journal of American Medical Informatics Association}. 2014.  doi:10.1136/amiajnl-2014-002642. \newline * \underline{Indicates co-first authors}
...
\begin{itemize}
\item Dmitriy Dligach, Timothy Miller, Guergana Savova. Semi-supervised Learning for Phenotyping Tasks. \emph{American Medical Informatics Association, Annual Meeting}. Under Review.
