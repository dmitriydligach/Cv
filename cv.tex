...
\begin{itemize}
\item *Chen Lin, *Dmitriy Dligach, *Timothy Miller, *Steven Bethard, Guergana Savova. Layered Temporal Modeling for the Clinical Domain. \emph{Journal of American Medical Informatics Association}. 2015. Under Review. \newline * \underline{Indicates co-first authors}
...
\begin{itemize}
\item Dmitriy Dligach, Timothy Miller, Guergana Savova. Semi-supervised Learning for Phenotyping Tasks. \emph{American Medical Informatics Association Symposium}. 2015. Under Review.
